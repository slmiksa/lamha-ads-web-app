    ...
    >
      ...
      >
        ...
        <span className="text-left leading-tight">
          <span className="block text-[9px] uppercase tracking-wide opacity-80 sm:text-[10px]">
            GET IT ON
          </span>
        ...
        <span
          dir="rtl"
          className="absolute -top-2 left-3 rounded-full bg-[var(--gold)] px-2 py-0.5 text-[10px] font-bold text-foreground"
        >
          قريباً
        </span>
      </div>
